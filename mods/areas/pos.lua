-- Part of this code comes from WorldEdit mod and it its AGPL.
areas.marker1 = {}
areas.marker2 = {}
areas.set_pos = {}
areas.pos1 = {}
...
areas.markPos1 = function(name)
	...
	if areas.marker1[name] ~= nil then
		areas.marker1[name]:remove()
...
areas.markPos2 = function(name)
	...
	if areas.marker2[name] ~= nil then
		areas.marker2[name]:remove()
